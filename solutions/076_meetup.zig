...
/// Tomohiko Sakamoto's algorithm for the weekday of a Gregorian date.
/// `month` is 1-based (1 = January) and `day` is the day of the month (1-31).
/// Returns the weekday with in range [Monday = 0, ..., Sunday = 6].
fn weekday(year: u32, month: u32, day: u32) u32 {
    const t = [12]u32{ 0, 3, 2, 5, 0, 3, 5, 1, 4, 6, 2, 4 };
